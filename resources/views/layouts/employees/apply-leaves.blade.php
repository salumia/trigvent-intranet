            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="card">
                    <div class="body">
                        ...
                        <form id="apply_leave_form" method="post" action="{{ route('store_apply_leaves') }}" enctype="multipart/form-data">
                            @csrf
                                ...
                                <div class="form-group">
                                    <div class="form-line">
                                        <input type="number" name="no_of_days" class="form-control"
                                            placeholder="No of days you want to take leave" value="">
                                    </div>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <div class="form-group">
                                    <textarea name="reason" id="" rows="6" style = "width:100%"></textarea>
                                        {{-- <div class="custome_errors1"></div> --}}
                                    </div>
                            ...
                            <button type="submit" class="btn bg-red btn-lg waves-effect " id="submit_btn">Apply</button>
                        </div>
                    </div>
